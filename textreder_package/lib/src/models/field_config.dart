...
class FieldConfig {
  ...
  factory FieldConfig.fromJson(Map<String, dynamic> json) {
    ...
    if (id == null || id.isEmpty) {
      throw ArgumentError('FieldConfig requires a non-empty "id" field');
    }
    
    final contentName = json['content_name'] as String?;
    if (contentName == null || contentName.isEmpty) {
      throw ArgumentError('FieldConfig requires a non-empty "content_name" field');
    }
    
    final regex = json['regex'] as String?;
    if (regex == null || regex.isEmpty) {
      throw ArgumentError('FieldConfig requires a non-empty "regex" field');
    }
